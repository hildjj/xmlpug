(function() {
  ...
  this.transform = transform = function(jadedata, xmldata, options) {
    var cache, dopts, err, fn, found, k, out, pretty, v, xmldoc;
    if (options == null) {
      options = {
        pretty: true
      };
