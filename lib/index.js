...
(function() {
  ...
  this.transformFile = transformFile = function(jadeFileName, xmlFileName, options) {
    if (options == null) {
      options = {
        pretty: true
      };
    ...
    return cache.read(jadeFileName, function(jadedata) {
      return compileJade(jadedata, options);
    }).then(function(jadeFunc) {
      if (xmlFileName) {
        return cache.read(xmlFileName, function(xmldata) {
